...
var GithubHandler = /** @class */ (function () {
    ...
    GithubHandler.prototype.singin = function () {
        var _this = this;
        firebase_app__WEBPACK_IMPORTED_MODULE_0__["auth"]().signInWithPopup(this.provider).then(function (res) {
            _this.credential = res.credential;
            _this.get_user_info().then(function (user_info) {
...
/* harmony import */ var _node_modules_ace_builds_src_min_noconflict_ace_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../node_modules/ace-builds/src-min-noconflict/ace.js */ "./node_modules/ace-builds/src-min-noconflict/ace.js");
/* harmony import */ var _node_modules_ace_builds_src_min_noconflict_ace_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_ace_builds_src_min_noconflict_ace_js__WEBPACK_IMPORTED_MODULE_1__);
...
var editor = _node_modules_ace_builds_src_min_noconflict_ace_js__WEBPACK_IMPORTED_MODULE_1__["edit"]('editor');
...
window.addEventListener('load', function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0__["ajax"]({
        ...
        document.getElementById('canvas').innerHTML = marked__WEBPACK_IMPORTED_MODULE_2__(data);
    }).fail(function (data) {
        console.log(data);
...
console.log(marked__WEBPACK_IMPORTED_MODULE_2__('# Marked in the browser\n\nRendered by **marked**.'));
document.getElementById('canvas').innerHTML = marked__WEBPACK_IMPORTED_MODULE_2__('# Marked in the browser\n\nRendered by **marked**.');
var git_handler = new _auth__WEBPACK_IMPORTED_MODULE_3__["GithubHandler"]();
